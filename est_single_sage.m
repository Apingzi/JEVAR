function [ tauOut,xiOut,thetaOut,Ysig] =  est_single_sage(ys1,ys2,ys,lTilde,zcLen,r,thetaRange,xiRange,M,d,lambda)
...
b = [zc1 conj(zc1)].';
yRefactor = kron((dxi.*b),atheta);
beta = yRefactor'*ysVec/(yRefactor'*yRefactor);
Ysig = beta*(dxi.*b)*atheta.';
end
